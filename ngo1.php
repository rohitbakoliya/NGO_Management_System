<?php
   ...
   if(isset($_POST['donation_sbmt']))
   {
     if($amount < 0)
     {
       $sqlneg = "INSERT INTO donation(id_user,id_ngo,amount) VALUES('$user_id','$ngo_id','$amount');";
       $result = mysqli_fetch_assoc($conn, $sqlneg);
    ...
    $result = mysqli_query($conn,$sql4);
       ...
       header("location: Shantineketan.php");
   }
?>
...
<html>
    ...
    <body class="main-background" style="opacity: 1;">
    <div class="donation-div">
    <form method="POST" action='ngo1.php'>
