...
<html>
  ...
  <body class="main-background" style="opacity:1.0">
    ...
    <img src="images/account.png" alt="avatar" class="avatar">
        <h2 style="color:black">Welcome <?php 
            ...
            echo $_SESSION['name']; ?>
        <h2>
    <button onclick="window.location.href='logout_handle.php'" class="btn btn-danger" style="margin-left:85%;margin-top:-20%">Logout</button>
